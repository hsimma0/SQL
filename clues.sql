...
LEFT JOIN countrylanguage 1 ON c.code = 1.countrycode
WHERE 1.language = 'Italian' and c.region = 'Southern Europe';
...
-- Write SQL query here
SELECT * FROM city c 
JOIN on c.countrycode = country.code 
WHERE country.code = 'SMR' and c.name != 'San Marino';
